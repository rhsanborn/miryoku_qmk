...
U_NP,              U_NP,              KC_ESC,           KC_SPC,     LT(U_GAMENUM, KC_TAB), KC_RETN,       HYPR_T(KC_BSPC),     TD(U_TD_U_BASE),   U_NP,              U_NP

#define MIRYOKU_LAYER_GAMENUM \
KC_F1,            KC_F2,            KC_F3,            KC_F4,            KC_GRV,         KC_LBRC,          KC_F7,            KC_F8,            KC_F9,            KC_RBRC,         \
